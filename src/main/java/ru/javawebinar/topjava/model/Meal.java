...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_BETWEEN_INCLUSIVE, query = "SELECT m FROM Meal m WHERE m.user.id = ?1 " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String GET_BETWEEN_INCLUSIVE = "Meal.getBetweenInclusive";
